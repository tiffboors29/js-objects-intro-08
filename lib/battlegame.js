...
infantry = {
  ...
  attack: function(character) {
    console.log('HIT');
    return character.health -= infantry.strength;
  }
};
...
artillery = {
  ...
  attack: function(character) {
    console.log('HIT');
    return character.health -= artillery.strength;
  }
 };
...
cavalry = {
  ...
  attack: function(character) {
    console.log('HIT');
    return character.health -= cavalry.strength;
  }
 };
...
//     console.log('HIT');
//     return attacker.health - defender.strength;
//  };

// console.log(attack(artillery, cavalry));
